  ...
  return (
    <div className='min-h-screen flex items-center justify-center'>
      <div className='text-center'>
        <h1 className='text-4xl font-bold mb-4'>{darkMode ? 'Dark Mode' : 'Light Mode'}</h1>
        <p className='mb-6'>Click the button below to switch between dark and light themes.</p>
        <button
          onClick={toggleTheme}
